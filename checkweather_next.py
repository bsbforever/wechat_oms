...
mailcontent='明日'+location+'白天天气为'+str(next_weather['next_day'])+',夜晚天气为'+str(next_weather['next_night'])+',最高气温为'+str(next_weather['next_high'])+'度,最低气温为'+str(next_weather['next_low'])+'度,风力为'+str(next_weather['next_scale'])+'级'

#print(mailcontent)
send_mail(to_list,'苏州明日天气预报',mailcontent)
